            ...
            <div class="table-list">
                <table class="table table-bordered">
                    ...
                    <tr v-for="item in list">
                        ...
                        <td>
                            <button v-if="item.task_id" class="btn btn-default btn-sm"
                                    v-on:click="detailHandler(item.task_id)">详情</button>
                            <router-link :to="{name:'addtask',query:{point_id:item.id},params:{
                                              item:item
                                        }}" class="btn btn-default btn-sm" v-else >
                                补货</router-link>
                        </td>
                    </tr>
                    </tbody>
    ...
    export default{
        ...
        methods:{
            ...
            getList:function (query) {
                ...
                this.$http.get("/v1/task/get_salespoint_list",{
                    params:param
